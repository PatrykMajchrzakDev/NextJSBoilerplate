...
export default function NavBar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 border-b backdrop-blur supports-[backdrop-filter]:bg-background/60 bg-white/80 dark:bg-black/80"
    >
      <div className="flex items-center justify-between p-4 lg:py-2 lg:px-4 max-w-7xl mx-auto">
